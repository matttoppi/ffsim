...
**Primary next action:** Restart the local server, re-prepare real draft `1391209065727688704` with league-created mock `1393721396240080896`, and verify that coupled season worlds build and monitoring starts. Do not claim `WAIT`, `REACH`, or personalization from one mock or before out-of-sample calibration.
